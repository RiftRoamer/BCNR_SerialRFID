...
class ListAllJMRICars(JDialog):
    def __init__(self):
        global changes
        changes = []
        JDialog.__init__(self, None, 'List of Cars from JMRI Operations rosters', True)
        ...
        southPanel = JPanel()
        noteText = JLabel('   This is a read-only display of all JMRI cars  ')
        ...
        centerPanel.setPreferredSize(Dimension(600,330))
